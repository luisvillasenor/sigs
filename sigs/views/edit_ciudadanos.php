					...
					<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					  <div class="modal-dialog">
					    <div class="modal-content">
						  ...
						  <form name="nuevoeditciudadano" class="form-horizontal" method="POST" action="<?php echo base_url('ciudadanos/actualizar');?>">
					      <div class="modal-body">
							<?php foreach ($get_one_ciudadano as $ciudadano) { ?>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="hidden" name="id_ciudadano" class="form-control" id="id_ciudadano" value="<?php echo $ciudadano->id_ciudadano;?>" readonly>
								    </div>
								</div>
								<div class="form-group">
								    
								    <div class="col-sm-10">
								      <input type="hidden" name="fecha_creacion" class="form-control" id="fecha_creacion" value="<?php echo $ciudadano->fecha_creacion;?>" readonly>
								    </div>
								</div>
								<div class="form-group">
							    ...
							    <select class="form-control" name="id_seccion" id="id_seccion" onchange="obtenerDistritoLocal()">
									<?php foreach ($get_all_secciones as $seccion):
								    	if ($seccion->id == $ciudadano->id_seccion) { ?>
								      		<option value="<?php echo $seccion->id;?>" selected><?php echo $seccion->seccion;?> - <?php echo $seccion->colonia;?></option>
								    	<?php }else{ ?>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-10">
								    	<input type="text" name="distrito" class="form-control" id="distrito" value="<?php echo $ciudadano->distrito;?>" readonly>
								    </div>
								</div>
								<div class="form-group">
								    <label for="distritolocal" class="col-sm-2 control-label">Distrito Local</label>
								    <div class="col-sm-10">
								    	<input type="text" name="distritolocal" class="form-control" id="distritolocal" value="<?php echo $ciudadano->distritolocal;?>" readonly>
								    </div>
								</div>
	...
	<div class="row well">
		<?php foreach ($get_one_ciudadano as $ciudadano) { ?>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="id_ciudadano" value="<?php echo $ciudadano->id_ciudadano;?>" readonly placeholder="ID">
			    </div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			    <label for="distrito" class="col-sm-2 control-label">Distrito Federal</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="distrito" value="<?php echo $ciudadano->distrito;?>" readonly placeholder="Distrito">
			    </div>
			</div>
			<div class="form-group">
			    <label for="distritolocal" class="col-sm-2 control-label">Distrito Local</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="distritolocal" value="<?php echo $ciudadano->distritolocal;?>" readonly placeholder="Distrito">
			    </div>
			</div>
		<?php } ?>
	</div>
